...
while not stop:
    ...
    while not acceptable_input:
        continue_answer = input('Perform another calculation? (y/n): ')
        if continue_answer.lower() == 'n':
            stop = True
            acceptable_input = True
        elif continue_answer.lower() != 'y':
            print('Unsupported command. Type "y" to continue or "n" to stop calculation')
        acceptable_input = True
